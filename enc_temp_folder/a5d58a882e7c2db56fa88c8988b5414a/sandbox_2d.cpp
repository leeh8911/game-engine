...
void Sandbox2D::OnAttach()
{
    ...
    m_TextureBarrel = gauri::SubTexture2D::CreateFromCoords(m_SpriteSheet, {8, 2}, {128, 128});
...
void Sandbox2D::OnUpdate(gauri::Timestep ts)
{
    ...
    gauri::Renderer2D::DrawQuad({1.0f, 0.0f, 0.5f}, {1.0f, 1.0f}, m_TextureBarrel);
    gauri::Renderer2D::DrawQuad({-1.0f, 0.0f, 0.5f}, {1.0f, 1.0f}, m_TextureTree);
    gauri::Renderer2D::EndScene();
}
